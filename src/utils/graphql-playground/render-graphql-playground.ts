...
const stylePath = '/playground/css/index.css';
const iconPath = '/playground/assets/favicon.png';
const scriptPath = '/playground/js/middleware.js';

function renderPlayground(options: GraphqlOptions) {
    return `
      <!DOCTYPE html>
      <html>
      <head>
